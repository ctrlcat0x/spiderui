...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
            canonical: `https://spiderui.dev/docs/components/${component.slug}`,
        },
        openGraph: {
            title: `${component.title} Component`,
            description: component.description,
    ...
    return (
        <div className="flex flex-col lg:flex-row w-full h-full min-h-screen lg:h-screen bg-[#f3f4f6] dark:bg-[#080808] overflow-hidden">
            ...
            <div className="w-full lg:basis-1/2 lg:max-w-1/2 h-full flex flex-col relative z-20 bg-[#f3f4f6] dark:bg-[#080808]">
                {/* Gradients */}
                <div className="absolute top-0 left-0 right-0 z-30 h-40 bg-gradient-to-b from-[#f3f4f6] via-[#f3f4f6] to-transparent dark:from-[#080808] dark:via-[#080808] dark:to-transparent pointer-events-none backdrop-blur-sm [mask-image:linear-gradient(to_bottom,black_20%,transparent)]" />
