...
const textShadowClasses: Record<RichButtonColor, string> = {
  default:
  ...
  (
    ...
    return (
      <Component
        ...
        data-size={size}
        className={cn(
          "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap border border-zinc-950/35 bg-linear-to-b font-medium text-white shadow-md shadow-zinc-950/20 inset-shadow-2xs inset-shadow-white/25 transition-[filter] duration-200 hover:brightness-110 active:brightness-95 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 dark:border-zinc-950/50 dark:bg-linear-to-t [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
          color === "default" && "dark:text-zinc-900",
          colorClasses[color],
          sizeClasses[size],
          className,
        )}
