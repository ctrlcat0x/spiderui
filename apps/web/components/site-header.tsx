...
export function SiteHeader({
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 w-full ${transparent ? "" : "border-b border-border/40 bg-white/60 backdrop-blur dark:bg-[#111]/60"}`}
    >
      <div className="flex items-center h-14 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="flex flex-1 items-center gap-2 sm:gap-4">
          {sidebarToggle && <div className="md:hidden">{sidebarToggle}</div>}
