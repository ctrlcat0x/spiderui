...
const DEFAULT_DIA_FOOTER_THEME: DiaFooterTheme = "dia-browser"

const currentYear = new Date().getFullYear()

export function DiaFooter({
  colors,
  theme = DEFAULT_DIA_FOOTER_THEME,
  copyrightText,
  scrollContainer,
}: DiaFooterProps) {
  ...
  const activeTheme = useMemo(
    () =>
      DIA_FOOTER_THEME_PRESETS[theme] ?? DIA_FOOTER_THEME_PRESETS[DEFAULT_DIA_FOOTER_THEME],
    [theme],
  )
