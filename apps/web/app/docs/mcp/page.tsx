...
export default function McpDocsPage() {
  ...
  const selectedRegistryUrl = "https://spiderui.dev/r/{name}.json"
      ...
      <main className="max-w-3xl mx-auto pt-32 pb-32 px-6 sm:px-8 relative z-10">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-zinc-500 dark:text-zinc-400 leading-relaxed">
            Integrating MCP with Spider UI lets you control it via AI.
          </p>
        </div>
        ...
        <div className="space-y-16">
          ...
          <Section title="Usage" id="usage" className="pt-2">
            <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed">
              You can now ask your IDE to use any Spider UI component. Here are some examples:
            </p>
