# Spider UI Internal Documentation

This directory contains internal documentation for maintaining and extending the Spider UI library.
...
- **Live Site:** https://spiderui.dev
- **Registry URL:** https://spiderui.dev/r/{component}.json
- **Install Example:** `pnpm dlx shadcn@latest add @spiderui/showcase-card`
