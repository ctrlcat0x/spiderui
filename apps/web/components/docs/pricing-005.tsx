...
import { Pricing005Preview } from "@/components/docs/previews/pricing-005-preview"

const importCode = `import { Pricing005 } from "@/components/ui/pricing-005"`

const usageCode = `export default function Page() {
  return <Pricing005 />
}`

export async function Pricing005Docs() {
  const sourceCode =
    (await readComponentSource("pricing-005")) ||
  ...
  return (
    <DocsPageLayout
      ...
      preview={<Pricing005Preview />}
      previewCode={usageCode}
      installPackageName="pricing-005"
      installDependencies="clsx tailwind-merge @hugeicons/react @hugeicons/core-free-icons motion"
      installSourceCode={sourceCode}
      installSourceFilename="components/ui/pricing-005.tsx"
