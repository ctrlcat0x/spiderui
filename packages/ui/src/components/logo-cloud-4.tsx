...
const KEYFRAMES = `
  @keyframes logo-cloud-4-marquee-x { from { transform: translateX(0); } to { transform: translateX(-50%); } }
  @keyframes logo-cloud-4-marquee-x-reverse { from { transform: translateX(-50%); } to { transform: translateX(0); } }
  @keyframes logo-cloud-4-marquee-y { from { transform: translateY(0); } to { transform: translateY(-50%); } }
  @keyframes logo-cloud-4-marquee-y-reverse { from { transform: translateY(-50%); } to { transform: translateY(0); } }
`

const ANIMATION_NAME: Record<string, string> = {
  left: "logo-cloud-4-marquee-x",
  right: "logo-cloud-4-marquee-x-reverse",
  up: "logo-cloud-4-marquee-y",
  down: "logo-cloud-4-marquee-y-reverse",
}
...
export interface LogoCloud4Item {
  name: string
  svg: React.ReactNode
}

export interface LogoMarqueeProps {
  logos: LogoCloud4Item[]
  label?: string
  duration?: number
  gap?: number
  reverse?: boolean
