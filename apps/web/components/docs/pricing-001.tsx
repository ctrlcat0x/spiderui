...
import { Pricing001Preview } from "@/components/docs/previews/pricing-001-preview"

const importCode = `import { Pricing001 } from "@/components/ui/pricing-001"`

const usageCode = `export default function Page() {
  return <Pricing001 />
}`

export async function Pricing001Docs() {
  const sourceCode =
    (await readComponentSource("pricing-001")) ||
