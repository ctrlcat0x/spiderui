...
const links = {
  ...
  resources: [
    ...
    { label: "GitHub", href: "https://github.com/ctrlcat0x/spiderui", external: true },
    { label: "Sponsor", href: "https://github.com/sponsors/ctrlcat0x", external: true },
  ],
  connect: [
    { label: "Twitter / X", href: "https://x.com/ctrlcat0x", external: true },
    { label: "GitHub", href: "https://github.com/ctrlcat0x", external: true },
  ],
}
      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-zinc-200/60 dark:border-zinc-800/60 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-zinc-400 dark:text-zinc-600">
            © {new Date().getFullYear()} Spider UI. Built by{" "}
            <Link
