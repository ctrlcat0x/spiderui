...
export function LogosCarousel({
  ...
  const groups = React.useMemo<LogoCloud3Item[][]>(() => {
    const result: LogoCloud3Item[][] = []
...
function AnimatedLogo({
  ...
  const style: React.CSSProperties = animate
    ? {
        animationName:
          state === "enter" ? "logo-cloud-3-enter" : "logo-cloud-3-exit",
