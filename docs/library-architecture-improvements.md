...
Based on an analysis of production-grade libraries (specifically ReactBits) and comparison with the current state of Spider UI, here are high-impact improvements to help the library scale.
