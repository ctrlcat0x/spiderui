...
} from "@/components/docs/previews/logo-cloud-004-preview"

const importCode = `import { LogoMarquee } from "@/components/ui/logo-cloud-004"`
...
const marqueeImportCode = `import { Marquee } from "@/components/ui/logo-cloud-004"`

export async function LogoCloud004Docs() {
  const sourceCode =
    (await readComponentSource("logo-cloud-004")) ||
  ...
  return (
    <DocsPageLayout
      ...
      preview={<LogoCloud004Preview />}
      previewCode={usageCode}
      installPackageName="logo-cloud-004"
      installDependencies="clsx tailwind-merge"
      installSourceCode={sourceCode}
      installSourceFilename="components/ui/logo-cloud-004.tsx"
      usageNote={usageNote}
