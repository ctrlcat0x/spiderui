# 🧩 Spider UI - Complete Component Creation Guide

This guide documents the **complete workflow** for adding a new component to the Spider UI library. Follow each step in order.
...
```bash
npx shadcn@latest add @spiderui/{component-name}
```
...
```
Create a new Spider UI component called "[COMPONENT_NAME]".
