  ...
  return (
    <div className="fixed left-1 top-3 z-50 flex w-[calc(100%-0.5rem)] items-center justify-between gap-3 pointer-events-none sm:left-3 sm:w-[calc(100%-1.5rem)] lg:absolute lg:left-6 lg:top-6 lg:w-[calc(50%-3rem)] lg:max-w-[calc(50%-1.5rem)]">
      <div className="flex min-w-0 items-center gap-2">
        ...
        {!isPreviewExpanded ? (
          <div className="pointer-events-auto inline-flex min-h-5 min-w-0 items-center gap-2 text-[15px] font-semibold leading-5 text-black/50 mix-blend-multiply [font-family:ui-sans-serif,system-ui,sans-serif] dark:text-white/50 dark:mix-blend-lighten">
            <Link
              href="/docs"
